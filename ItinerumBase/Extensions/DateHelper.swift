...
public extension Date {
    ...
    /*
        Initializes a new Date() object based on a date string, format, optional timezone and optional locale.
    ...
    */
    ...
    /// Converts the date to string based on DateFormatter date style and time style with optional relative date formatting, optional time zone and optional locale.
...
extension Date {
    static func updateTime(inDate:Date, fromDate:Date)-> Date {
        
        let calendar = Calendar.current
        let year = calendar.component(.year, from: inDate)
        let month = calendar.component(.month, from: inDate)
        let day = calendar.component(.day, from: inDate)
        
        let hour = calendar.component(.hour, from: fromDate)
        let minutes = calendar.component(.minute, from: fromDate)
        let second = calendar.component(.second, from: fromDate)
    ...
    static func updateDate(inDate:Date, fromDate:Date)-> Date {
        ...
        let hour = calendar.component(.hour, from: inDate)
        let minutes = calendar.component(.minute, from: inDate)
        let second = calendar.component(.second, from: inDate)
